...
class ZenViewModel @Inject constructor(
    ...
    private val exceptionHandler = CoroutineExceptionHandler { _, throwable ->
        Log.e("ZenViewModel", "Coroutine exception: ${throwable.localizedMessage}", throwable)
    }
    ...
    fun startGame() {
        ...
        analyticsRepository.logEvent("game_started", mapOf("challenge" to "ZEN_MODE"))
        startTimer()
    ...
    private fun revealAndHideTile(tileId: Int) {
        ...
        scope.launch(parentJob) {
            ...
            // Zen Mode: 50/50 ratio for coins and bombs
