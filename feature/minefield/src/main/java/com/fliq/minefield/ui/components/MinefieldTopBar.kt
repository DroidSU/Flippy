...
fun MinefieldTopBar(
    ...
    Row(
        ...
        MinefieldIconButton(icon = Icons.AutoMirrored.Filled.ArrowBack, onClick = onBackClick)
        ...
        MinefieldIconButton(icon = Icons.AutoMirrored.Filled.HelpOutline, onClick = onHelpClick)
    }
}
