...
fun MinefieldGameOverDialog(
    ...
    val accentColor = MaterialTheme.colorScheme.error // Red for Minefield
...
@Composable
private fun MinefieldActionRequestButton(
    text: String,
    icon: ImageVector,
    primary: Boolean,
    accentColor: Color,
