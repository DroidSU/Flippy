                    ...
                    Column(
                        ...
                        Column(verticalArrangement = Arrangement.spacedBy(12.dp)) {
                            MirageRuleItem(
                                ...
                                title = "DECEPTIVE TILES",
                                description = "Coins might transform into Bombs at the last second.",
                                accent = accentColor
                            )
                            MirageRuleItem(
                                iconVector = Icons.Default.Favorite,
                                title = "KEEP HEARTS",
                                description = "Missing 3 coins will cost a heart.",
                                accent = BombRed,
                                isVector = true
                            )
                            MirageRuleItem(
                                ...
                                title = "WATCH BOMBS",
                                description = "Don't tap them or you'll lose a heart.",
                                accent = BombOrange
                            )
                        }
