...
fun FrenzyTopBar(
    ...
    Row(
        ...
        FrenzyIconButton(icon = Icons.AutoMirrored.Filled.ArrowBack, onClick = onBackClick)
        ...
        FrenzyIconButton(icon = Icons.AutoMirrored.Filled.HelpOutline, onClick = onHelpClick)
    }
}
