// In file: /app/src/main/java/com/sujoy/flippy/components/auth/OtpEntryView.kt
    ...
    ElevatedCard(
        ...
        Box(contentAlignment = Alignment.TopStart) {
            ...
            Column(
                ...
                // --- Resend Code Text ---
                TextButton(onClick = { /* TODO: Implement resend logic in ViewModel */ }, enabled = !isLoading && canResend) {
